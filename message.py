...
class Message:
    ...
    def write(self):
        ...
        dep_date = data["route"][0]["local_departure"][0:10]
        ret_date = data["route"][1]["local_departure"][0:10]
        dep_time = data["route"][0]["local_departure"][11:16]
        ret_time = data["route"][1]["local_departure"][11:16]
